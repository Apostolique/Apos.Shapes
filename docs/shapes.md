# Shapes
This page lists every shape that the ShapeBatch can draw. If you don't have a ShapeBatch set up yet, read the [Getting started](./getting-started.md) guide first.
...
Anywhere a shape takes a `Color`, it can take a gradient instead. Read the [Gradients](./gradients.md) guide to learn how.
