...
namespace Apos.Shapes {
    ...
    public struct VertexShape : IVertexType {
        ...
        public VertexShape(Vector3 position, Vector2 textureCoordinate, Color c1, Color c2, float thickness = 0f) {
            Position = position;
        ...
        public override string ToString() {
            return "{{Position:" + this.Position + " Color1:" + this.Color1 + " Color2:" + this.Color1 + " TextureCoordinate:" + this.TextureCoordinate + " Thickness:" + this.Thickness + "}}";
        }
        ...
        static VertexShape() {
            var elements = new VertexElement[] {
                ...
                new VertexElement(sizeof(float) * 5 + sizeof(int) * 2, VertexElementFormat.Single, VertexElementUsage.TextureCoordinate, 1)
            };
